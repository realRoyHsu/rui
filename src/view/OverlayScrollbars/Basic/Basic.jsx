...
export default function Basic() {
    ...
    return (
        <div>
            ...
            <ScrollBar className="roy_basic os-theme-dark"
                       id="roy_sss"
                ...
                <div style={{ whiteSpace: 'nowrap', wordBreak: 'break-all'}}>
                    ...
                    <br/>>tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.<br/>
            ...
            <Button icon="caret-right"
                    onClick={()=>ScrollBarBasic.current.addExt('myBasicExtension')}
                    type="primary">Primary</Button>
            <Button icon="caret-left"
                    onClick={()=>ScrollBarBasic.current.removeExt('myBasicExtension')}>Default</Button>
        </div>
    );
}
